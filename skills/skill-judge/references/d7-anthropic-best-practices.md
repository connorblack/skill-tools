...
This reference is Skill-first. When the target is an agent file, apply the portable authoring principles rather than the literal `SKILL.md` packaging rules.
...
- **File paths matter**: Claude navigates your skill directory like a filesystem. Use forward slashes (`references/guide.md`), not backslashes
- **Name files descriptively**: Use names that indicate content: `form_validation_rules.md`, not `doc2.md`
- **Organize for discovery**: Structure directories by domain or feature
  - Good: `references/finance.md`, `references/sales.md`
...
When the user asks about revenue, Claude reads SKILL.md, sees the reference to `references/finance.md`, and invokes bash to read just that file. The sales.md and product.md files remain on the filesystem, consuming zero context tokens until needed. This filesystem-based model is what enables progressive disclosure. Claude can navigate and selectively load exactly what each task requires.
